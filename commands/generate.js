...
function generateFiles(result, templateConf) {
    let files = FileManager.generateTemplates(templateConf, result);
...
module.exports = function (opts) {
    ...
    let templateConf = settings[opts.name].default;
    ...
    if (opts._.length > 2) {
        ...
        let values = templateConf.variables.reduce(function (obj, variable) {
